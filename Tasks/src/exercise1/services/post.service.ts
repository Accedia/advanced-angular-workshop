...
/*
  Note:
  It's a good idea to have services that handle common api requests.
  This avoids code duplication throughout your app. For this example
  we use hardcoded data.
*/
